...
Som det forventes producerer ovenstående instruktioner nøjagtig de forventede
data i registrerne. Der bliver også skrevet til hukommelsaddressen 000000 en værdi
på 4. Den anden sw operation bliver dog ikke skrevet, så addresse 000004 forbliver 0.
Dette skyldes at lw ikke når at loade før sw skal bruge værdien. Der er således tale om 
en uafklaret hazard, som vi desværre ikke har fået løst. (\figref[fig:arithmetic-results]).
\vfill
\columnbreak
\begin{figure}[H]
	\center
...
\subsubsection{Branch Hazards/Forwarding}
...
