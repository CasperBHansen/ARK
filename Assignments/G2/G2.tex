...
\newcommand{\figref[1]}{se Figure~\ref{#1}}        % use for referencing figures
...
\begin{multicols}{2}
\begin{abstract}
I følgende opgave er der blevet gennemarbejdet anden Godkendelsesopgaver i kurset Maskinarkitektur på Københavns Universitet. I opgaven beskriver vi hvordan vi implementerede en pipelined MIPS i programmet LogiSim. 
???Hvad skriver man egentlig helt præcis i sådan et afsnit???
\end{abstract}
\vfill
\columnbreak
\tableofcontents
...
Vores pipelines instruktion set (\figref[fig:instruction-set]) er rimelig simpel og indeholder `kun' 14 instruktioner. På følgende tabel er disse instruktioner blevet beskrevet kort.
