...
Vores pipelines instruktionssæt (\figref[fig:instruction-set]) er rimelig
...
Til sidst tog vi os af {\it jumps}, hvilket viste sig at være mere udfordrende
end først antaget, og også årsagen til, at vi må erkende, at vores kredsløb
har nogle fejl på dette område. [afklar hvilke fejl?]
